...
const RiderOrderItemCard = ({ orderItem, showProductDetails, setShowProductDetails, selectedOrder, setSelectedOrder, setIsOrderStatusModalOpen }) => {
  return (
...
export default RiderOrderItemCard;
